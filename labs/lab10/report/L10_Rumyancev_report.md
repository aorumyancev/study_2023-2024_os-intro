...
В командном режиме я нажал "u" и отменил последнее действие, удаление строки.

![](image/10.png){#fig:001 width=70%}

После перешёл в режим последней строки и ввел w для сохранения файла и q для выхода, нажал enter и файл закрылся
